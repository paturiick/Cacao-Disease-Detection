...
<template>
  <section>
    ...
    <div class="grid grid-cols-4 gap-4 print:grid-cols-4">
      ...
      <div class="col-span-1 p-5 bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col print:shadow-none print:border-slate-300">
        <span class="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Avg Accuracy</span>
        <span class="text-4xl font-black text-[#0F172A]">{{ avgAccuracy }}<span class="text-lg text-slate-400 font-bold ml-1">%</span></span>
      </div>
