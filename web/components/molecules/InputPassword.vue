...
// Dynamically switch between 'text' and 'password'
  ...
  <div class="w-full group animate-slide-up" style="animation-delay: 100ms;">
    ...
    <div class="relative">
      ...
      <button 
        ...
        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-[#658D1B] transition-colors duration-200 focus:outline-none"
      >
